...
export const CreateCallSession = async (req: Request, res: Response): Promise<void> => {
  try {
    const currentUserId = req.user.userId;
    const { conversationId, type } = req.body as {
...
export const JoinCallSession = async (req: Request, res: Response): Promise<void> => {
  try {
    const currentUserId = req.user.userId;
    const { id } = req.params;
...
export const LeaveCallSession = async (req: Request, res: Response): Promise<void> => {
  try {
    const currentUserId = req.user.userId;
    const { id } = req.params;
...
export const EndCallSession = async (req: Request, res: Response): Promise<void> => {
  try {
    const currentUserId = req.user.userId;
    const { id } = req.params;
