...
import { UserRegisterInputs ,UserLoginInputs } from "../validators/user.validation.js"
...
export const LoginUser = async(req:Request,res:Response):Promise<void>=>{
    try {
        const {email,password} = req.body as unknown as UserLoginInputs;
...
export const UpdateUserProfile = async(req:Request,res:Response):Promise<void>=>{
    try {
        const userId = req.user?.userId;
        const {firstName,lastName,role} = req.body as Partial<UserRegisterInputs>;
        
            const updateData:Partial<UserRegisterInputs> = {
                ...(firstName && {firstName}),
                ...(lastName && {lastName}),
                ...(role && {role}),
            };
