...
export default function CTASection() {
  return (
    <motion.section
      ...
      <div className="absolute inset-100 bg-gradient-to-b from-purple-600/20 via-blue-500/10 to-transparent dark:from-purple-900/30 dark:via-blue-900/20 blur-3xl" />
